...
const messages: Record<Locale, Record<string, string>> = {
  'en-US': {
    ...
    'publish.title': 'Container image',
    'publish.context': 'Build context',
    'publish.dockerfile': 'Dockerfile',
    'publish.start': 'Build and push',
    'publish.queued': 'Queued',
    'publish.running': 'Building and pushing',
    'publish.completed': 'Published',
    'publish.failed': 'Failed',
    'publish.cancelled': 'Cancelled',
    'publish.empty': 'No container images published yet.',
    'publish.image': 'Immutable image',
    'publish.logs': 'Build log',
    'publish.history': 'Publication history',
    'publish.runtimeUnavailable': 'Publishing requires an active runtime and no active Agent run.',
  },
  'zh-CN': {
    ...
    'publish.start': '构建并推送',
    'publish.queued': '等待中',
    'publish.running': '正在构建并推送',
    'publish.completed': '已发布',
    'publish.failed': '失败',
    'publish.cancelled': '已取消',
    'publish.empty': '还没有发布容器镜像。',
    'publish.image': '不可变镜像',
    'publish.logs': '构建日志',
    'publish.history': '发布记录',
    'publish.runtimeUnavailable': '发布需要有效运行环境，且 Agent 当前没有运行任务。',
  },
};
