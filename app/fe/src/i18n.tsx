...
const messages: Record<Locale, Record<string, string>> = {
  'en-US': {
    ...
    'deep.label': 'Deep Exploration',
    'deep.description': 'Deep exploration',
    'deep.toggleAria': 'Toggle deep exploration',
    ...
    'workspace.send': 'Send',
    'workspace.previewBooting': 'Booting preview...',
  ...
  'zh-CN': {
    ...
    'deep.label': '深度探索',
    'deep.description': '深度探索',
    'deep.toggleAria': '切换深度探索',
    ...
    'workspace.send': '发送',
    'workspace.previewBooting': '预览启动中...',
