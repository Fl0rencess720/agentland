...
func TestSandboxAuth_RejectMissingToken(t *testing.T) {
	...
	router.GET("/api/fs/tree", func(c *gin.Context) {
		c.JSON(http.StatusOK, gin.H{"ok": true})
	})

	req := httptest.NewRequest(http.MethodGet, "/api/fs/tree", nil)
...
func TestSandboxAuth_RejectSessionMismatch(t *testing.T) {
	gin.SetMode(gin.ReleaseMode)
...
func TestSandboxAuth_AcceptsValidTokenAndSession(t *testing.T) {
	gin.SetMode(gin.ReleaseMode)
